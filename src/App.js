      ...
      <section className="featured">
        <div className="left">
          <div className="inner transition2">
            ...
            >
              Step into the Star Wars universe and command legendary characters
              like Luke Skywalker and Darth Vader in a fast-paced multiplayer
              card game. Build a powerful deck, strategize and defeat opponents
              from around the world in epic battles. Play now and experience the
              ultimate Star Wars gaming experience.
            </p>
          </div>
        </div>
      ...
      <section id="skills-section" className="skills-section">
        <div className="skills-description">
          ...
          <p>
            ...
            <span>
              <a
                href="https://www.linkedin.com/in/robert-alexandru-lungu-6a27301b9/"
                target="_blank"
              >
                LinkedIn
              </a>
